#!/usr/bin/env bash
spark-submit \
--class com.soto.spark.session.UserVisitSessionAnalyzeSpark \
--num-executors 1 \
--driver-memory 100m \
...
/home/sotowang/user/aur/ide/idea/idea-IU-182.3684.101/workspace/sparkhomework/target/spark-homework-1.0.jar \
${1}
